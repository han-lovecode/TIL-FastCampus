/*
 Q1) 자연수 n을 입력받아 삼각형 모양의 문자를 출력하는 printTriangle 함수를 완
성해주세요. (30점)
...
/*
Q2) 자연수 n을 입력받아 n이 짝수이면 '짝수입니다.', 홀수이면 '홀수입니다.'를
출력하는 isEvenNumber 함수를 완성해주세요. (10점)
제한사항: n은 1이상의 양수입니다.
*/
...
Chicken 클래스 constructor는 name(string), type(string)를 입력받아
Chicken 인스턴스를 생성합니다.
